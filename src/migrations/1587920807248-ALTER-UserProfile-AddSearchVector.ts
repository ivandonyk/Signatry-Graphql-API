...
export class ALTERUserProfileAddSearchVector1587920807248 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        // add search vector column
        await queryRunner.query('ALTER TABLE user_profile ADD COLUMN search_vector TSVECTOR');

        // create gin index on search vector column
        await queryRunner.query(
            'CREATE INDEX user_profile_search ON "user_profile" USING gin(search_vector)'
        );
        ...
        // trigger function to run on user_profile insert/update
        await queryRunner.query(/*sql*/ `
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('DROP INDEX IF EXISTS user_profile_search');
        await queryRunner.query('ALTER TABLE user_profile DROP COLUMN IF EXISTS search_vector');
    }
}
