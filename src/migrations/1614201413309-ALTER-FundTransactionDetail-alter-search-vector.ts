...
export class ALTERFundTransactionDetailAlterSearchVector1614201413309 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TRIGGER IF EXISTS fund_transaction_detail_vector_update ON "fund_transaction_detail"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TRIGGER IF EXISTS fund_transaction_detail_searchvector_insert_update ON "fund_transaction_detail"`);
        await queryRunner.query(`DROP FUNCTION IF EXISTS fund_transaction_detail_searchvector_insert_update`);
