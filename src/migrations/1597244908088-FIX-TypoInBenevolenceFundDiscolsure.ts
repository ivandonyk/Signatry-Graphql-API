...
const APP_SETTINGS = {
    ...
    purposeCategories: [
        ...
        },
        {
            ...
            disclosure:
                'By submitting this grant, I affirm that it will only benefit an individual(s) whom the grant recipient has reviewed and approved for charitable support and will not include me or someone related to me.'
        },
...
export class FIXTypoInBenevolenceFundDiscolsure1597244908088 implements MigrationInterface {
