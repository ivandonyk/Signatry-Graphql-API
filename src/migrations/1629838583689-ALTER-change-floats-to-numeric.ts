...
export class ALTERChangeFloatsToNumeric1629838583689 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP VIEW IF EXISTS vw_temp_detailed_holding');
        ...
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN units TYPE numeric');
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN market_value TYPE numeric');
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN cost_basis TYPE numeric');
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN cumulative_average_cost TYPE numeric');
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN cumulative_realized TYPE numeric');
        await queryRunner.query('ALTER TABLE holding ALTER COLUMN cumulative_unrealized TYPE numeric');

        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN units TYPE numeric');
        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN market_value TYPE numeric');
        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN cost_basis TYPE numeric');
        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN cumulative_average_cost TYPE numeric');
        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN cumulative_realized TYPE numeric');
        await queryRunner.query('ALTER TABLE pool_investment_holding ALTER COLUMN cumulative_unrealized TYPE numeric');

        await queryRunner.query('ALTER TABLE fund_transaction ALTER COLUMN amount TYPE numeric');
        await queryRunner.query('ALTER TABLE fund_transaction_detail ALTER COLUMN amount TYPE numeric');

        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN amount TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN fee_amount TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN flow_amount TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN unit_price TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN units TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN cost_basis TYPE numeric');
        await queryRunner.query('ALTER TABLE institution_account_transaction ALTER COLUMN realized_gain TYPE numeric');
